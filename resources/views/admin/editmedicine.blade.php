    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item d-inline-block w-auto"><a href="{{ url('admin/detail') }}" class="no-underline" style="color: #888A88"><h3>Azithral 500 Tablet</h3></a></li>
                <li class="breadcrumb-item active d-inline-block w-auto" aria-current="page"><h3>Edit Medicine</h3></li>
            </ol>
        </nav>
        ...
        <form onsubmit="redirectAfterSubmit(event)">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="medicineID" required>
            </div>
            <div class="mb-3">
                <label for="medicineGroup" class="form-label">Medicine Group</label>
                <select class="form-select" id="medicineGroup" required>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="howToUse" rows="3" required></textarea>
            </div>
            <div class="mb-3">
                <label for="sideEffects" class="form-label">Side Effects</label>
                <textarea class="form-control" id="sideEffects" rows="3" required></textarea>
            </div>
