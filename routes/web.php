...
// Route::get('/pembelianObat', [PembelianObatController::class, 'index']);//menampilkan seluruh data yang ada pada pembelian
// Route::get('/pembelianObat/{id}', [PembelianObatController::class, 'showByIdTransaksi']);// menampilkan yang ada di cart id, untuk tampilan cart
// Route::post('/pembelianObat/store/{id}', [PembelianObatController::class, 'store'])->name('pembelianObat.store');
// Route::put('/pembelianObat/update{id}', [PembelianObatController::class, 'update']);
// Route::delete('/pembelianObat/delete', [PembelianObatController::class, 'delete']);// untuk menghapus dari database
